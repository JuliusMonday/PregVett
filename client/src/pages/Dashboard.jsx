// src/pages/Dashboard.jsx (updated with port fix and consistent fetch)
    ...
    const fetchPregnancyStats = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setPregnancyStats(data.stats || null); // Fallback to null if no stats
            } else {
                console.error('Failed to fetch pregnancy stats:', response.statusText);
                setPregnancyStats(null);
            }
        } catch (error) {
